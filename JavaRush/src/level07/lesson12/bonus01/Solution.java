...
Task: The program enters information about the cats from the keyboard and displays them on the screen.
Example:
...
public class Solution {
    ...
    public static class Cat {
        ...
        public String toString() {
            return "Cat name is " + name + ", age is " + age + ", weight is " + weight + 
            		", tail = " + tailLength;
        }
    }
}
